...
#define USBD_HID_INTERFACE           0  //HID interface index
#define USBD_CDC_CMD_INTERFACE       1  //CDC CMD interface index
#define USBD_CDC_DATA_INTERFACE      2  //CDC Data interface index
