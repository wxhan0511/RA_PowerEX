...
void SystemClock_Config(void)
{
  ...
  */
  RCC_ClkInitStruct.ClockType = RCC_CLOCKTYPE_HCLK|RCC_CLOCKTYPE_SYSCLK
                              |RCC_CLOCKTYPE_PCLK1|RCC_CLOCKTYPE_PCLK2;//PCLK1:AHB1 PCLK2:AHB2  HFCLK:AHB
  RCC_ClkInitStruct.SYSCLKSource = RCC_SYSCLKSOURCE_PLLCLK;//168
  RCC_ClkInitStruct.AHBCLKDivider = RCC_SYSCLK_DIV1;//168
  RCC_ClkInitStruct.APB1CLKDivider = RCC_HCLK_DIV4;//42
  RCC_ClkInitStruct.APB2CLKDivider = RCC_HCLK_DIV2; //84
